...
app = FastAPI(
    title="LangChain Colosseo",
    description="Multilingual Translation and Grammar Analysis with LangChain",
    version="1.0.0"
)
...
if __name__ == "__main__":
    logger.info(f"Starting LangChain Colosseo on {SERVER_HOST}:{SERVER_PORT}")
