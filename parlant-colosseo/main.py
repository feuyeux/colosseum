...
app = FastAPI(
    title="Parlant Colosseo",
    description="Multilingual Translation and Grammar Analysis with Parlant",
    version="1.0.0"
)
...
if __name__ == "__main__":
    logger.info(f"Starting Parlant Colosseo on {SERVER_HOST}:{SERVER_PORT}")
